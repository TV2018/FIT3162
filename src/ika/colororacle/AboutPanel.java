...
public class AboutPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        textLabel.setText("<html><center>Version 1.3.1<br><br>Programming by<br>Bernhard Jenny & Nathaniel Vaughn Kelso<br>Austin Teck, Fergus Makmur & Sokunthervy Vann - Monash University<br>and other contributors.<br><br>Monash University Final Year Project (FIT3162)<br><br>&copy; B. Jenny, A. Teck, F. Makmur, S. Vann & N.V. Kelso 2006–2018.<br>CC-BY using the MIT License<br><br>For updates and further information see:<br></center></html>");
